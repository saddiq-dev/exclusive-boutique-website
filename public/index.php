        ...
        <div class="product__item">
          <div class="product__item__pic set-bg" data-setbg="./assets/img/product/product-1.jpg">
            ...
            <ul class="product__hover">
              ...
              <li>
                <a href="#"><img src="./assets/img/icon/compare.png" alt="" />
                  <span>Compare</span></a>
              </li>
              <li>
    ...
    <div class="row">
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="blog__item">
          ...
          <div class="blog__item__text">
            <span><img src="./assets/img/icon/calendar.png" alt="" /> 16 February
              2020</span>
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="blog__item">
          ...
          <div class="blog__item__text">
            <span><img src="./assets/img/icon/calendar.png" alt="" /> 21 February
              2020</span>
      ...
      <div class="col-lg-4 col-md-6 col-sm-6">
        <div class="blog__item">
          ...
          <div class="blog__item__text">
            <span><img src="./assets/img/icon/calendar.png" alt="" /> 28 February
              2020</span>
